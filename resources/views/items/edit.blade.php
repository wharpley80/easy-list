...
<div class="list-page">
  <div class="container">
    ...
    <p class="lead">
			{{ link_to_route('lists.show', 'Back', [$my_list_id], ['class' => 'btn btn-default btn-sm']) }} 
		</p>
		  ...
		  <div class="modal-dialog modal-sm">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        {!! Form::model($list_item, [ 'route' => [ 'lists.items.update', $my_list_id, $list_item->id ], 'method' => 'put', 'class' => 'signin-form' ]) !!}
		          {!! csrf_field() !!}
